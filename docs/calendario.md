# Calendario 2026 — Turno Noche, martes

16 martes consecutivos, del **11/08/2026** al **24/11/2026**. Ningún feriado nacional cae en martes dentro de la cursada (17/08 y 12/10 caen lunes; 20/11 cae viernes).

| # | Fecha | Clase | Lectura teórica | Entrega |
|---|---|---|---|---|
| 1 | **mar 11/08** | Kickoff: cursado, equipos y primer deploy | MIDAS, MDA, MDE | — |
| 2 | mar 18/08 | La especificación y TypeScript como contrato | Usabilidad y accesibilidad | Cuestionario clase 1 |
| 3 | mar 25/08 | Modelado de datos y persistencia | Programación Extrema (XP) | Cuestionario clase 2 |
| 4 | mar 01/09 | La API: REST y Server Actions | Scrum | Cuestionario clase 3 |
...
| 16 | **mar 24/11** | **DEMO DAY** — presentaciones, retrospectiva y recuperatorios | Programación paralela (2) | Cuestionario clase 16 |

## Reglas de fechas

- **Asistencia:** se requiere el **70%** de las clases para aprobar la cursada.

- **Cuestionarios:** se entregan al **inicio** de la clase siguiente a la lectura y se siguen clase a clase. **Al 24/11 tienen que estar todos entregados**; los que falten inciden en la nota de concepto.
...
| **17/11** | **Parcial II** |
| **24/11** | **Demo Day** con datos reales |
